...
case $os_type in
    ...
    Darwin*)
        ...
        ;;
    *)
        echo "Cannot identify OS (got ${os_type})!"
...
"${PWD}/${executable_name}" -name "$VALHEIM_SERVER_NAME" -port $VALHEIM_PORT -world "$VALHEIM_WORLD" -password "$VALHEIM_PASSWORD"  -nographics -batchmode
